<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Order List.aspx.cs" Inherits="_1_List" %>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:ListBox ID="lstOrderList" runat="server" OnSelectedIndexChanged="lstOrderList_SelectedIndexChanged" style="z-index: 1; left: 10px; top: 34px; position: absolute; height: 385px; width: 397px"></asp:ListBox>
        <p>
            &nbsp;</p>
        <p>
        ...
        <p>
            &nbsp;</p>
        <asp:Label ID="lblFilter" runat="server" style="z-index: 1; left: 10px; top: 482px; position: absolute; height: 34px; width: 392px" Text="Enter a Order ID"></asp:Label>
