<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Customer ConfirmDelete.aspx.cs" Inherits="_1_ConfirmDelete" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblSure" runat="server" style="z-index: 1; left: 10px; top: 19px; position: absolute; height: 32px; width: 660px" Text="Are you sure you want to delete this record?"></asp:Label>
